...
/cdsc_nfs/cdsc0/software/spark/cloud-scale-bwamem-0.1.0/target/cloud-scale-bwamem-0.1.0-assembly.jar cs-bwamem-profile -bfn 1 -bPSW 1 -sbatch 10 -bPSWJNI 1 -jniPath /cdsc_nfs/cdsc0/shared_lib/jniNative.so -oChoice 1 -oPath /hdfs2/data/InputFiles/HCC1954/HCC1954_100Mreads_test.sam -R "@RG	HCC1954	LB:HCC1954	SM:HCC1954" -isSWExtBatched 1 -bSWExtSize 32768 -FPGAAccSWExt 1 -FPGASWExtThreshold 64 -jniSWExtendLibPath "/curr/genomics_spark/shared_lib/jniSWExtend.so" 1 /hdfs2/data/ReferenceMetadata/human_g1k_v37.fasta hdfs://cdsc0:9000/user/ytchen/data/SC_data/pair_end/HCC1954_100Mreads.fq 1
